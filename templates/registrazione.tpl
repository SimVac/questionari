        ...
        >
            <div class="max-w-xl lg:max-w-3xl">
                ...
                <form action="index.php" method="post" class="mt-8 grid grid-cols-6 gap-6" id="myForm">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <label for="LastName" class="block text-sm font-medium text-gray-700 pb-2">
                            Last Name
                        </label>
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <label for="PasswordConfirmation" class="block text-sm font-medium text-gray-700 pb-2">
                ...
                I want to receive emails about events, product updates and company announcements.
                    ...
                    <div class="col-span-6">
                        <p class="text-sm text-gray-500">
                            ...
                            <span class="text-gray-700"> terms and conditions </span>
                            and
