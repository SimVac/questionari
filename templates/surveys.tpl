    ...
    <header class="bg-white">
        <div class="mx-auto flex h-16 max-w-screen-xl items-center gap-8 px-4 sm:px-6 lg:px-8 justify-between">
            <div class="flex flex w-1/4 justify-between items-center">
                ...
                <h1 class="text-center text-2xl font-bold text-orange-500 sm:text-3xl">QuestionAPP</h1>
            </div>
            ...
            <div class="flex flex items-center justify-end md:justify-between">
                ...
                <div class="flex items-center gap-4">
                    <div class="sm:flex sm:gap-4">
                        <a
                                class="block text-teal-600" href="#"
                        >
                            <svg width="3rem" height="3rem" viewBox="0 0 1024 1024" class="icon" version="1.1"
                                 xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a>
                                <div>
                                    <div class="justify-between sm:flex">
                                        <div class="flex-1">
                                            <h3 class="text-xl font-medium text-orange-600">Prova</h3>
                                            <p class="text-gray-500 mt-2 pr-2">Prova</p>
                                        </div>
                        ...
                        <li class="p-5 bg-white rounded-md shadow-sm">
                            <a>
                                <div>
                                    <div class="justify-between sm:flex">
                                        <div class="flex-1">
                                            <h3 class="text-xl font-medium text-orange-600">Prova compilato</h3>
                                            <p class="text-gray-500 mt-2 pr-2">Prova compilato</p>
                                        </div>
                                        <div class="mt-5 space-y-4 text-sm sm:mt-0 sm:space-y-2">
