...
<div class="flex flex-col h-screen">
    ...
    <div class="flex flex-col justify-between h-full">
        <div class="flex flex-row justify-center h-4/6 items-center ">
        ...
        <div class="bg-neutral-50 flex justify-center items-center h-2/6">
            <div class="flex flex-row justify-around w-10/12 h-5/6 items-center">
                <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow">
                    ...
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-semibold tracking-tight text-orange-600">Need help in QuestionAPP?</h5>
                    </a>
